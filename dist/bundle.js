(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('expr-eval'), require('Konva')) :
    typeof define === 'function' && define.amd ? define(['expr-eval', 'Konva'], factory) :
    (global = global || self, global.Plotter = factory(global.exprEval, global.Konva));
}(this, (function (exprEval, Konva) { 'use strict';

    Konva = Konva && Object.prototype.hasOwnProperty.call(Konva, 'default') ? Konva['default'] : Konva;
    ...
    class Plotter {
        ...
        constructor(
            ...
            // drag
            this.stage.on('dragend', e => self.refresh());
        }
         ...
         */
        plot(func, color) {
            let expr = exprEval.Parser.parse(func);
